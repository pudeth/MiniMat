...
Route::middleware(['auth', 'admin'])->prefix('admin')->group(function () {
    ...
    Route::get('/cashiers/create', [AdminController::class, 'createCashier'])->name('admin.cashiers.create');
    Route::post('/cashiers', [AdminController::class, 'storeCashier'])->name('admin.cashiers.store');
    Route::get('/cashiers/{id}/edit', [AdminController::class, 'editCashier'])->name('admin.cashiers.edit');
    Route::put('/cashiers/{id}', [AdminController::class, 'updateCashier'])->name('admin.cashiers.update');
    Route::delete('/cashiers/{id}', [AdminController::class, 'deleteCashier'])->name('admin.cashiers.delete');
